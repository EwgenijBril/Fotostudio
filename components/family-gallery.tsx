...
export function FamilyGallery({ images, isVisible, onImageClick }: FamilyGalleryProps) {
  return (
    <div className="py-32 bg-dark relative overflow-hidden">
      <div className="container-cinematic">
        <div
          className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 ${isVisible ? "animate-cinematic-slide-up" : ""}`}
        ...
        >
          ...
          {/* Row 2 - Одна широкая */}
          <div 
            className={`col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-4 group cursor-pointer corner-accent ${isVisible ? "animate-cinematic-fade-in" : ""}`}
