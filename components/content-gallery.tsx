...
export function ContentGallery({ images, isVisible, onImageClick }: ContentGalleryProps) {
  return (
    <div className="py-32 bg-dark relative overflow-hidden">
      <div className="container-cinematic">
        <div
          className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 ${isVisible ? "animate-cinematic-slide-up" : ""}`}
          style={{ animationDelay: "0.4s" }}
        >
          {/* Row 1 - Большая + маленькая */}
          <div 
            className={`col-span-1 md:col-span-2 lg:col-span-2 xl:col-span-3 group cursor-pointer corner-accent ${isVisible ? "animate-cinematic-fade-in" : ""}`}
          ...
          {/* Row 3 - Широкая полоса */}
          <div 
            className={`col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-5 group cursor-pointer corner-accent ${isVisible ? "animate-cinematic-fade-in" : ""}`}
            style={{ animationDelay: "1.1s" }}
            onClick={() => onImageClick(5)}
          >
            <div className="relative w-full aspect-[5/1] overflow-hidden rounded-2xl cinematic-shadow hover-cinematic">
              <Image
