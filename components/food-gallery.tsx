...
export function FoodGallery({ images, isVisible, onImageClick }: FoodGalleryProps) {
  return (
    <div className="py-32 bg-dark relative overflow-hidden">
      <div className="container-cinematic">
        <div
          className={`grid grid-cols-7 gap-4 ${isVisible ? "animate-cinematic-slide-up" : ""}`}
          style={{ animationDelay: "0.4s" }}
        >
          {/* Row 1 - Большая + две маленькие */}
          <div 
            className={`col-span-4 group cursor-pointer corner-accent ${isVisible ? "animate-cinematic-fade-in" : ""}`}
          ...
          <div 
            className={`col-span-7 group cursor-pointer corner-accent ${isVisible ? "animate-cinematic-fade-in" : ""}`}
            style={{ animationDelay: "0.9s" }}
            onClick={() => onImageClick(3)}
          >
            <div className="relative w-full aspect-[7/1] overflow-hidden rounded-2xl cinematic-shadow hover-cinematic">
              <Image
