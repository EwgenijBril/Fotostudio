...
export function CreativeGallery({ images, isVisible, onImageClick }: CreativeGalleryProps) {
  return (
    <div className="py-32 bg-dark relative overflow-hidden">
      <div className="container-cinematic">
        <div
          className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8 gap-4 ${isVisible ? "animate-cinematic-slide-up" : ""}`}
          style={{ animationDelay: "0.4s" }}
        >
          {/* Row 1 - Большая центральная + две маленькие */}
          <div 
            className={`col-span-1 md:col-span-1 lg:col-span-2 xl:col-span-3 group cursor-pointer corner-accent ${isVisible ? "animate-cinematic-fade-in" : ""}`}
            style={{ animationDelay: "0.6s" }}
            onClick={() => onImageClick(0)}
          >
            <div className="relative w-full aspect-[3/4] overflow-hidden rounded-2xl cinematic-shadow hover-cinematic">
              <Image
          ...
          <div 
            className={`col-span-1 md:col-span-1 lg:col-span-1 xl:col-span-2 group cursor-pointer corner-accent ${isVisible ? "animate-cinematic-fade-in" : ""}`}
            style={{ animationDelay: "0.7s" }}
            onClick={() => onImageClick(1)}
          >
            <div className="relative w-full aspect-[2/3] overflow-hidden rounded-2xl cinematic-shadow hover-cinematic">
              <Image
          ...
          <div 
            className={`col-span-1 md:col-span-2 lg:col-span-1 xl:col-span-3 group cursor-pointer corner-accent ${isVisible ? "animate-cinematic-fade-in" : ""}`}
          ...
          {/* Row 2 - Широкая полоса */}
          <div 
            className={`col-span-1 md:col-span-2 lg:col-span-4 xl:col-span-8 group cursor-pointer corner-accent ${isVisible ? "animate-cinematic-fade-in" : ""}`}
            style={{ animationDelay: "0.9s" }}
            onClick={() => onImageClick(3)}
          >
            <div className="relative w-full aspect-[8/2] md:aspect-[4/2] lg:aspect-[4/2] xl:aspect-[8/2] overflow-hidden rounded-2xl cinematic-shadow hover-cinematic">
              <Image
          ...
          <div 
            className={`col-span-1 md:col-span-1 lg:col-span-2 xl:col-span-4 group cursor-pointer corner-accent ${isVisible ? "animate-cinematic-fade-in" : ""}`}
            style={{ animationDelay: "1.1s" }}
            onClick={() => onImageClick(5)}
          >
            <div className="relative w-full aspect-[4/3] overflow-hidden rounded-2xl cinematic-shadow hover-cinematic">
              <Image
          ...
          <div 
            className={`col-span-1 md:col-span-2 lg:col-span-1 xl:col-span-2 group cursor-pointer corner-accent ${isVisible ? "animate-cinematic-fade-in" : ""}`}
          ...
          >
            <div className="relative w-full aspect-[4/2] overflow-hidden rounded-2xl cinematic-shadow hover-cinematic">
              <Image
          ...
          <div 
            className={`col-span-1 md:col-span-1 lg:col-span-2 xl:col-span-5 group cursor-pointer corner-accent ${isVisible ? "animate-cinematic-fade-in" : ""}`}
            style={{ animationDelay: "1.7s" }}
            onClick={() => onImageClick(11)}
          >
            <div className="relative w-full aspect-[5/3] overflow-hidden rounded-2xl cinematic-shadow hover-cinematic">
              <Image
