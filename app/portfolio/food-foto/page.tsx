        ...
        <div className="container-cinematic relative z-10">
          <div className={`mb-8 ${isVisible ? "animate-cinematic-slide-in" : ""}`}>
            ...
            <div className="flex flex-wrap gap-6">
              ...
              >
                <Link href="/kontakt"><span>Food-Shooting buchen</span></Link>
              </Button>
              <Button
                asChild
                size="lg"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className={`${isVisible ? "animate-cinematic-slide-in" : ""}`} style={{ animationDelay: "1.6s" }}>
              ...
              <ul className="space-y-6 text-white/80 font-light">
                {[
                  "Professionelle Food-Styling und Präsentation",
                  "Appetitliche Aufnahmen, die zum Kauf anregen",
                  "Shooting im Restaurant oder im Studio",
                  "Menü-Fotografie und Produktaufnahmen",
            ...
            <div className={`${isVisible ? "animate-cinematic-slide-in-right" : ""}`} style={{ animationDelay: "1.8s" }}>
              ...
              <div className="space-y-6">
                {[
                  { title: "Food Basic", price: "180€", duration: "2 Stunden Shooting", images: "15 bearbeitete Bilder" },
                  { title: "Food Standard", price: "300€", duration: "3 Stunden Shooting", images: "25 bearbeitete Bilder" },
                  { title: "Food Premium", price: "450€", duration: "4 Stunden Shooting", images: "40 bearbeitete Bilder" },
                ].map((pkg, index) => (
                  <div
                    key={pkg.title}
                  ...
                  >
                    <div className="flex items-center gap-4 mb-4">
                      <div className="relative w-12 h-12 border border-gold/30 rounded-lg flex items-center justify-center group-hover:border-gold/60 transition-all duration-500">
                        <Utensils className="h-6 w-6 text-gold/70 stroke-[1.5] group-hover:text-gold/90 transition-colors duration-500" />
            ...
            {[
              {
                ...
                number: "80+",
                title: "Restaurants",
                description: "Zufriedene Restaurants und Cafés"
              },
              {
                icon: Award,
                number: "95%",
                title: "Mehr Bestellungen",
                description: "Steigerung der Bestellungen durch professionelle Food-Fotos"
              },
              {
                icon: Camera,
                number: "500+",
                title: "Gerichte fotografiert",
                description: "Appetitliche Aufnahmen für Menüs und Social Media"
              },
            ].map((stat, index) => (
              <div
                key={stat.title}
        ...
        <div className="container-cinematic text-center relative z-10">
          <div className={`${isVisible ? "animate-cinematic-slide-up" : ""}`} style={{ animationDelay: "3.4s" }}>
            <div className="text-gold text-lg font-light tracking-[0.2em] mb-6 text-dramatic">
              BEREIT FÜR IHR FOOD-SHOOTING?
            </div>
            <h2 className="font-light tracking-wide mb-8 text-cinematic text-glow">
              Lassen Sie uns Ihre
              <span className="block text-gold">Gerichte appetitlich präsentieren</span>
            </h2>
            <p className="text-white/90 mb-12 max-w-3xl mx-auto font-light leading-relaxed">
              Kontaktieren Sie mich für ein unverbindliches Beratungsgespräch und planen Sie Ihr perfektes Food-Shooting.
            </p>
