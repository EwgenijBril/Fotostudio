        ...
        <div className="container-cinematic relative z-10">
          <div className={`mb-8 ${isVisible ? "animate-cinematic-slide-in" : ""}`}>
            ...
            <div className="flex flex-wrap gap-6">
              ...
              >
                <Link href="/kontakt"><span>Reportage buchen</span></Link>
              </Button>
              <Button
                asChild
                size="lg"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className={`${isVisible ? "animate-cinematic-slide-in" : ""}`} style={{ animationDelay: "1.6s" }}>
              ...
              <ul className="space-y-6 text-white/80 font-light">
                {[
                  "Diskrete Dokumentation ohne Störung des Events",
                  "Natürliche, ungestellte Momente",
                  "Vollständige Berichterstattung des gesamten Tages",
                  "Schnelle Lieferung der finalen Bilder",
            ...
            <div className={`${isVisible ? "animate-cinematic-slide-in-right" : ""}`} style={{ animationDelay: "1.8s" }}>
              ...
              <div className="space-y-6">
                {[
                  { title: "Event Basic", price: "400€", duration: "4 Stunden", images: "50 bearbeitete Bilder" },
                  { title: "Event Standard", price: "650€", duration: "6 Stunden", images: "80 bearbeitete Bilder" },
                  { title: "Event Premium", price: "900€", duration: "8 Stunden", images: "120 bearbeitete Bilder" },
                ].map((pkg, index) => (
                  <div
                    key={pkg.title}
                  ...
                  >
                    <div className="flex items-center gap-4 mb-4">
                      <div className="relative w-12 h-12 border border-gold/30 rounded-lg flex items-center justify-center group-hover:border-gold/60 transition-all duration-500">
                        <FileText className="h-6 w-6 text-gold/70 stroke-[1.5] group-hover:text-gold/90 transition-colors duration-500" />
            ...
            {[
              {
                icon: FileText,
                number: "100+",
                title: "Events dokumentiert",
                description: "Erfolgreich durchgeführte Reportagen und Events"
              },
              {
                icon: Award,
                number: "24h",
                title: "Schnelle Lieferung",
                description: "Bereits nach 24 Stunden erhalten Sie Ihre Bilder"
              },
              {
                icon: Camera,
                number: "∞",
                title: "Momente",
                description: "Unvergessliche Erinnerungen für die Ewigkeit"
              },
            ].map((stat, index) => (
              <div
                key={stat.title}
        ...
        <div className="container-cinematic text-center relative z-10">
          <div className={`${isVisible ? "animate-cinematic-slide-up" : ""}`} style={{ animationDelay: "3.4s" }}>
            <div className="text-gold text-lg font-light tracking-[0.2em] mb-6 text-dramatic">
              BEREIT FÜR IHRE REPORTAGE?
            </div>
            <h2 className="font-light tracking-wide mb-8 text-cinematic text-glow">
              Lassen Sie uns Ihre
              <span className="block text-gold">wichtigsten Momente dokumentieren</span>
            </h2>
            <p className="text-white/90 mb-12 max-w-3xl mx-auto font-light leading-relaxed">
              Kontaktieren Sie mich für ein unverbindliches Beratungsgespräch und planen Sie Ihre perfekte Reportage.
            </p>
