        ...
        <div className="container-cinematic relative z-10">
          <div className={`mb-8 ${isVisible ? "animate-cinematic-slide-in" : ""}`}>
            ...
            <div className="flex flex-wrap gap-6">
              ...
              >
                <Link href="/kontakt"><span>Produkt-Shooting buchen</span></Link>
              </Button>
              <Button
                asChild
                size="lg"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className={`${isVisible ? "animate-cinematic-slide-in" : ""}`} style={{ animationDelay: "1.6s" }}>
              ...
              <ul className="space-y-6 text-white/80 font-light">
                {[
                  "Weißer Hintergrund oder Lifestyle-Settings",
                  "Mehrere Perspektiven und Detailaufnahmen",
                  "E-Commerce optimierte Formate",
            ...
            <div className={`${isVisible ? "animate-cinematic-slide-in-right" : ""}`} style={{ animationDelay: "1.8s" }}>
              ...
              <div className="space-y-6">
                {[
                  { title: "Produkt Basic", price: "120€", duration: "1 Stunde Shooting", images: "5 bearbeitete Bilder" },
                  { title: "Produkt Standard", price: "200€", duration: "2 Stunden Shooting", images: "10 bearbeitete Bilder" },
                  { title: "Produkt Premium", price: "300€", duration: "3 Stunden Shooting", images: "15 bearbeitete Bilder" },
                ].map((pkg, index) => (
                  <div
                    key={pkg.title}
                  ...
                  >
                    <div className="flex items-center gap-4 mb-4">
                      <div className="relative w-12 h-12 border border-gold/30 rounded-lg flex items-center justify-center group-hover:border-gold/60 transition-all duration-500">
                        <Package className="h-6 w-6 text-gold/70 stroke-[1.5] group-hover:text-gold/90 transition-colors duration-500" />
            ...
            {[
              {
                ...
                number: "70%",
                title: "Mehr Verkäufe",
                description: "Steigerung der Verkäufe durch professionelle Produktfotos"
              },
              {
                icon: Award,
                number: "1000+",
                title: "Produkte fotografiert",
                description: "Erfolgreich abgeschlossene Produkt-Shootings"
              },
              {
                icon: Camera,
                number: "24h",
        ...
        <div className="container-cinematic text-center relative z-10">
          <div className={`${isVisible ? "animate-cinematic-slide-up" : ""}`} style={{ animationDelay: "3.4s" }}>
            <div className="text-gold text-lg font-light tracking-[0.2em] mb-6 text-dramatic">
              BEREIT FÜR IHR PRODUKT-SHOOTING?
            </div>
            <h2 className="font-light tracking-wide mb-8 text-cinematic text-glow">
              Lassen Sie uns Ihre
              <span className="block text-gold">Produkte verkaufsstark präsentieren</span>
            </h2>
            <p className="text-white/90 mb-12 max-w-3xl mx-auto font-light leading-relaxed">
              Kontaktieren Sie mich für ein unverbindliches Beratungsgespräch und planen Sie Ihr perfektes Produkt-Shooting.
            </p>
